...
EOF
```
+ `--apiVersion`：ube-scheduler dropped support for configuration files with apiVersion componentconfig/v1alpha1. Ensure kube-scheduler is configured using command-line flags or a configuration file with apiVersion kubescheduler.config.k8s.io/v1alpha1 before upgrading to 1.13 
...
## 参考
1. kube-scheduler.yaml --- https://github.com/kubernetes/kubernetes/issues/66874 
